...
aus314data$Education <- factor(aus314data$Education)
levels(aus314data$Education) <- c("High School Diploma","Undergraduate Degree","Graduate Degree")
us314data$Education <- factor(us314data$Education)
levels(us314data$Education) <- c("High School Diploma","Undergraduate Degree","Graduate Degree")
...
aus314data$Political_Spectrum <- factor(aus314data$Political_Spectrum)
levels(aus314data$Political_Spectrum) <- c("Left-wing","Center","Right-wing")

us314data$Political_Spectrum <- factor(us314data$Political_Spectrum)
levels(us314data$Political_Spectrum) <- c("Left-wing","Center","Right-wing")
